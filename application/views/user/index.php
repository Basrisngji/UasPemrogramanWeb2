                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="logo mt-15">
                                        <a href="index.html"><img src="<?=base_url()?>/images/logoo.png" alt=""></a>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-7">
                            <div class="welcome-text">
                                ...
                                <h2>
                                <span>SELAMAT DATANG DI</span> <span class="coloring">Ecorik</span>
                                </h2>
                                ...
                                <p class="welcome-desc">Kami menyediakan tempat yang baik, lokasi yang strategis, ruangan yang nyaman dan pelayanan prima <br>
                                Sehingga pelanggan tidak merasa kapok setelah datang kesini</p>
                                <div class="explore">
                                    <a href="#">PENASARAN ?</a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-75">
                            <h2>Jenis <span>Vilaa</span></h2>
                            <p>Kami menyediakan beberapa kamar, cocok untuk pasangan, teman, maupun keluarga</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        <p>Copyright© Created by <a href="https://freethemescloud.com/"> Ecorik Villa</a></p>
                    </div>
                </div>
            </div>
        </div>
